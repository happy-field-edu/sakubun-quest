...
const CHARACTERS = {
  hero:   { name:'作文のゆうしゃ', emoji:'🦸', img:'assets/characters/hero.png' },
  hakase: { name:'作文はかせ', emoji:'🦉', img:'assets/characters/hakase.png' },
  maou:   { name:'マチガエールまおう', emoji:'🐸', img:'assets/characters/maou.png' }
};
...
/* ===================== WORLD 1 げんこう用紙の森 ===================== */
{
  ...
  childExplanation:'だい名は 1行目。上を 2〜3マス あけて 書きます。',
...
},
{
  ...
  childExplanation:'名前は 2行目。名字と 名前の あいだを 1マス あけます。',
...
},
{
  ...
  childExplanation:'あたらしい だんらくの さいしょは、かならず 一マス あけます。',
...
},
{
  ...
  skill:'行のさいごの 「、」「。」', difficulty:2,
  title:'「、」「。」は つぎの行の 上に 書かない',
  childExplanation:'「、」「。」は つぎの行の 上に 書きません。さいごの 字と 同じマスです。',
...
},
{
  ...
  childExplanation:'「、」は 読むとき ひと休みする ところに 入れます。',
...
},
{
  ...
  childExplanation:'だんらくの さいしょが 一マス あいて いませんでした。',
...
},
{
  ...
  skill:'文の おわりの 「。」', difficulty:1,
  title:'文の おわりには「。」をつける',
  childExplanation:'文が おわったら「。」を つけます。「。」も 一マス つかいます。',
...
/* ===================== WORLD 2 文字のどうくつ ===================== */
{
  ...
  childExplanation:'「わたしは」の「は」。「わ」と 読んでも「は」と 書きます。',
...
},
{
  ...
  childExplanation:'「学校へ」の「へ」。「え」と 読んでも「へ」と 書きます。',
...
},
{
  ...
  childExplanation:'「パンを」の「を」。「お」と 読んでも「を」と 書きます。',
...
},
{
  ...
  childExplanation:'「らっぱ」「がっこう」の つまる音は 小さい「っ」です。',
...
},
{
  ...
  childExplanation:'ねじれる音は 小さい「ゃ・ゅ・ょ」で 書きます。',
...
},
{
  ...
  title:'カタカナの のばす音は「ー」',
  childExplanation:'カタカナで のばす音は「ー」を つかいます。',
...
},
{
  ...
  title:'小さい字も 一マス つかう',
  childExplanation:'小さい「っ」「ゃ」も、1つで 一マス つかいます。',
...
},
{
  ...
  title:'は・へ・を を 見なおそう',
  childExplanation:'「へ」と「を」。声に 出して 読むと 見つけやすいよ。',
...
/* ===================== WORLD 3 おしゃべり城 ===================== */
{
  ...
  childExplanation:'話した ことばは、かぎかっこ「　」で かこみます。',
...
},
{
  ...
  skill:'かい話文の 行かえ', difficulty:2,
  title:'かい話文は 行を かえて 書く',
  childExplanation:'かい話文は、行を かえて 書きはじめます。',
...
},
{
  ...
  childExplanation:'かい話文が 2行に なったら、2行目も 一マス あけます。',
...
},
{
  ...
  childExplanation:'おわりの「。」と とじかっこは、同じマスに 入れます。',
...
},
{
  ...
  childExplanation:'かい話文の あとは、行を かえて 一マス あけます。',
  correctExample:'「おはよう。」\n　ぼくも手をふりました。',
...
},
{
  ...
  title:'とじかっこを わすれない',
  childExplanation:'かぎかっこは、はじめの「と おわりの」が セットです。',
...
},
{
  ...
  childExplanation:'かい話文の「は、行の いちばん上から 書きます。',
...
/* ===================== WORLD 4 文しょうロード ===================== */
{
  ...
  skill:'しゅ語とじゅつ語', difficulty:1,
  title:'「だれが」を 書くと 分かりやすい',
  childExplanation:'「だれが」「どうした」が そろうと よく つたわります。',
...
},
{
  ...
  title:'一つの文を 長くしすぎない',
  childExplanation:'「〜て、〜て」と つづけず、「。」で 切りましょう。',
...
},
{
  ...
  skill:'できごとの じゅんばん', difficulty:2,
  title:'あった じゅんばんに 書く',
  childExplanation:'作文は、あった じゅんばんに 書くと 分かりやすいよ。',
...
},
{
  ...
  childExplanation:'「そして」は、ならべる・つけ足す ときに つかいます。',
...
},
{
  ...
  childExplanation:'「それから」は、つぎに おきた ことに つかいます。',
...
},
{
  ...
  childExplanation:'ならべる なら「そして」、つぎの ことなら「それから」。',
...
},
{
  ...
  childExplanation:'話が かわる ところで 行を かえ、一マス あけます。',
...
/* ===================== WORLD 5 マチガエールまおう城 ===================== */
{
  ...
  skill:'できごとを くわしく', difficulty:2,
  title:'書いたら、もう一歩 くわしく',
  childExplanation:'できごとを 書いたら もう一歩。大きさや 色を 足そう。',
...
},
{
  ...
  title:'そのときの 気もちを 書く',
  childExplanation:'できごとの あとに 気もちを 書くと よくなります。',
...
},
{
  ...
  childExplanation:'気もちの つぎは「どうして そう思ったのか」を 書こう。',
...
},
{
  ...
  title:'どんな音？ 何が 見えた？',
  childExplanation:'どんな音？ 何が 見えた？ 思い出して 書こう。',
...
},
{
  ...
  childExplanation:'においや、さわった かんじも 書いて みましょう。',
...
},
{
  ...
  childExplanation:'同じ ことばが つづいたら、べつの 言いかたに かえよう。',
...
},
{
  ...
  title:'書きおわったら 読みかえす',
  childExplanation:'書きおわったら もう一かい 読みかえしましょう。',
...
},
{
  ...
  skill:'「すごかった」を くわしく', difficulty:3, boss:true,
  title:'「すごかった」の 中みを 書く',
  childExplanation:'「すごかった」の あとに、何が どう すごいかを 書こう。',
  correctExample:'花火が空いっぱいに広がって、びっくりしました。ドーンと大きな音がして、体にひびきました。',
  wrongExample:'花火がすごかったです。',
  hint:'「何が」「どう」すごかったのかな？ 大きさ・音・色・はやさを 思い出そう。',
  questionType:'rewrite',
  question:'まおう「花火が すごかったです。だけで じゅうぶんなのだ！」…もっと つたわるのは どれ？（いくつも 正かい）',
  choices:[
...
/* ---------- WORLD 2 ついか分 ---------- */
{
  ...
  title:'つまる音は 小さい「っ」で 書く',
  childExplanation:'「がっこう」の つまる音は 小さい「っ」で 書きます。',
...
},
{
  ...
  childExplanation:'「きって」「きっぷ」の つまる音も 小さい「っ」です。',
...
},
{
  ...
  childExplanation:'「しゅくだい」は「し」と 小さい「ゅ」で 書きます。',
...
},
{
  ...
  childExplanation:'「きょうしつ」の「ょ」は 小さく 書きます。',
...
},
{
  ...
  childExplanation:'「おもちゃ」の「ゃ」も 小さく 書きます。',
...
},
{
  ...
  childExplanation:'カタカナの のばす音は「ー」で 書きます。',
...
},
{
  ...
  childExplanation:'ひらがなでは「ー」を つかわず「あ」「い」で のばします。',
...
},
{
  ...
  title:'「わ」と 読んでも「は」と 書く',
  childExplanation:'「ぼくは」の「は」。「わ」と 読んでも「は」です。',
...
},
{
  ...
  skill:'じょし「は」', difficulty:1,
  title:'「わたしは」の「は」',
  childExplanation:'「わたしは」の「は」も、「は」と 書きます。',
...
},
{
  ...
  title:'「え」と 読んでも「へ」と 書く',
  childExplanation:'「うみへ」の「へ」。行く さきには「へ」を 書きます。',
...
},
{
  ...
  skill:'じょし「へ」', difficulty:1,
  title:'行く さきの「へ」',
  childExplanation:'「家へ」「学校へ」。行く さきには「へ」です。',
...
},
{
  ...
  title:'「お」と 読んでも「を」と 書く',
  childExplanation:'「ごはんを」の「を」。「なにを」の あとは「を」です。',
...
},
{
  ...
  skill:'じょし「を」', difficulty:1,
  title:'「なにを」の「を」',
  childExplanation:'「花を」「本を」。「なにを」の あとには「を」を 書きます。',
...
},
{
  ...
  childExplanation:'「わ・え・お」と 読んでも「は・へ・を」と 書きます。',
...
},
{
  ...
  childExplanation:'「プール」「ケーキ」の のばす音は「ー」で 書きます。',
...
},
{
  ...
  childExplanation:'一つの 文に 2つ あることも。声に 出して 読みかえそう。',
...
/* ---------- WORLD 3 ついか分 ---------- */
{
  ...
  childExplanation:'話した ことばは「　」で かこみ、行を かえて 書きます。',
...
},
{
  ...
  title:'「。」と とじかっこは 同じマス',
  childExplanation:'おわりの「。」と とじかっこは 同じマス。左上に「」」、右上に「。」。',
...
},
{
  ...
  skill:'かい話文の 中の 「。」', difficulty:2,
  title:'かい話文の 中にも「。」を つける',
  childExplanation:'かい話文の 中の 文にも、おわりに「。」を つけます。',
  correctExample:'「見て見て。」',
  wrongExample:'「見て見て」',
...
},
{
  ...
  childExplanation:'だれが 言ったのかを 書きそえると、よく 分かります。',
...
},
{
  ...
  childExplanation:'話す 人が かわったら、行を かえて 書きます。',
...
},
{
  ...
  childExplanation:'心の中で 思った ことも「　」で 書けます。',
...
},
{
  ...
  childExplanation:'かい話文の 行は、一マス あけずに 上から 書きます。',
...
},
{
  ...
  childExplanation:'かい話文の 行は、いちばん上から 書きはじめます。',
...
},
{
  ...
  title:'かい話を できごとの じゅんに 書く',
  childExplanation:'かい話文も、あった じゅんばんに 書きます。',
...
},
{
  ...
  title:'とじかっこを わすれない',
  childExplanation:'はじめの「と おわりの」は セットで つかいます。',
  correctExample:'「あそぼう。」',
  wrongExample:'「あそぼう。',
...
},
{
  ...
  childExplanation:'行を かえる・2行目は 一字下げ・おわりは 同じマス。',
...
/* ---------- WORLD 4 ついか分 ---------- */
{
  ...
  skill:'しゅ語を 書く', difficulty:1,
  title:'「だれが」を 書く',
  childExplanation:'「だれが」に あたる ことばを しゅ語と いいます。',
...
},
{
  ...
  title:'「どうした」を 書く',
  childExplanation:'「どうした」に あたる ことばを じゅつ語と いいます。',
...
},
{
  ...
  skill:'しゅ語と じゅつ語を あわせる', difficulty:3,
  title:'しゅ語と じゅつ語を あわせる',
  childExplanation:'「〜は」で はじめたら、さいごの ことばと あわせます。',
...
},
{
  ...
  skill:'一文を みじかく', difficulty:2,
  title:'一文を 長くしすぎない',
  childExplanation:'一つの 文に つめこまず、「。」で 切りましょう。',
...
},
{
  ...
  title:'ならべる ときは「そして」',
  childExplanation:'「そして」は、ならべたり つけ足したり する ときに。',
...
},
{
  ...
  childExplanation:'「それから」は、つぎに おきた ことを 書く ときに。',
...
},
{
  ...
  childExplanation:'ならべる なら「そして」、じゅんばんなら「それから」。',
...
},
{
  ...
  childExplanation:'一日の ことは、朝から じゅんばんに 書きます。',
  correctExample:'朝 → ひる → 夜',
  wrongExample:'夜 → 朝 → ひる',
  hint:'一日の はじまりは いつかな？',
  questionType:'order',
  question:'一日の じゅんばんに タップして ならべよう。',
  items:['ひるに きゅう食を 食べました。','夜、早く ねました。','朝、六時に おきました。'],
  answer:[2,0,1]
},
{
  ...
  childExplanation:'べつの 話に なる ときは、だんらくを かえます。',
...
},
{
  ...
  skill:'できごとの じゅんばん', difficulty:2,
  title:'した じゅんばんに 書く',
  childExplanation:'できごとは、じっさいに した じゅんばんに 書きます。',
  correctExample:'バスに のる → 山に つく → おべんとうを 食べる',
  wrongExample:'おべんとうを 食べる → バスに のる',
  hint:'えんそくは、まず 何から はじまるかな？',
  questionType:'order',
  question:'えんそくの じゅんばんに タップして ならべよう。',
  items:['山に つきました。','バスに のりました。','おべんとうを 食べました。'],
  answer:[1,0,2]
},
{
  id:'RULE-320', world:'w4', type:'skill', category:'bun',
  skill:'しゅ語を 書く', difficulty:2,
  title:'だれの ことか 分かるように 書く',
  childExplanation:'話す 人が かわる ときは「妹が」などと 書きます。',
...
},
{
  ...
  childExplanation:'だんらくを かえた ときも、はじめは 一マス あけます。',
...
},
{
  ...
  childExplanation:'りゆうが 前に ある ときは「だから」で つなぎます。',
...
},
{
  ...
  childExplanation:'「はじめ」「なか」「おわり」の じゅんに 書きます。',
...
},
{
  ...
  skill:'気もちを 書く', difficulty:2,
  title:'できごとの あとに 気もちを 書く',
  childExplanation:'できごとの あとに、その ときの 気もちを 書きたそう。',
...
},
{
  ...
  title:'目で 見た ことを 書く',
  childExplanation:'色・形・大きさなど、目で 見た ことを 書きましょう。',
...
},
{
  ...
  title:'聞こえた 音を 書く',
  childExplanation:'「ザーザー」など、聞こえた 音を 書いて みよう。',
...
},
{
  ...
  childExplanation:'においや あじを 書くと、読む 人まで 食べたく なります。',
...
},
{
  ...
  title:'さわった かんじを 書く',
  childExplanation:'つめたい・ふわふわなど、さわった かんじを 書こう。',
  ...
  choices:[
    ...
    { text:'とても つめたかったです。' },
    { text:'足を 入れた しゅんかん、ぴりっと するほど つめたく かんじました。' }
  ],
  answers:[0,2], anyOf:true
},
{
  ...
  title:'気もちの ことばを えらぶ',
  childExplanation:'「どきどきした」など、ぴったりの ことばを えらぼう。',
...
},
{
  ...
  skill:'りゆうを 書く', difficulty:3,
  title:'「〜からです。」で わけを 書く',
  childExplanation:'わけは「〜からです。」と 書くと はっきり つたわります。',
...
},
{
  ...
  childExplanation:'「たくさん」より「十こ」。数を 入れると はっきりします。',
...
},
{
  ...
  childExplanation:'言った ことばを そのまま 書くと、ばめんが 見えます。',
...
},
{
  ...
  childExplanation:'同じ ことばばかりに しないで、中みを 書きたそう。',
...
},
{
  ...
  title:'書きおわったら 読みかえす',
  childExplanation:'書きおわったら、声に 出して 読みかえしましょう。',
...
},
{
  ...
  childExplanation:'どこが どう 楽しかったのかを 書きましょう。',
...
},
{
  ...
  childExplanation:'書き出しに「いつ」「どこで」を 入れましょう。',
...
},
{
  ...
  title:'「書いたら、もう一歩！」',
  childExplanation:'くわしく する・気もちを 書く・わけを 書く。もう一歩！',
  correctExample:'できごと → くわしく → 気もち → りゆう',
  wrongExample:'できごとだけ 書いて おわり',
  hint:'できごとを 書いた あとに、もう一歩 すすめられるね。',
  questionType:'ox',
  question:'これは 正しい？',
  statement:'できごとを 書いたら、くわしく したり 気もちを 書いたり して、もう一歩 すすめる。',
  answer:true
},
...
/* ---------- WORLD 1 ついか分 ---------- */
{
  ...
  title:'だい名は 上から 書かない',
  childExplanation:'だい名を 1マス目から 書くと つまって 見えます。',
...
},
{
  ...
  childExplanation:'名前は 2行目。下を 1マス あけて そろえます。',
  correctExample:'下を 1マス あけて　山田　たろう',
...
},
{
  ...
  childExplanation:'作文の 書きはじめは、かならず 一マス あけます。',
...
},
{
  ...
  childExplanation:'「、」も つぎの行の 上には 書きません。',
...
},
{
  ...
  childExplanation:'文が おわったら「。」を つけます。',
...
},
{
  ...
  title:'小さい字も 1マス つかう',
  childExplanation:'小さい「っ」「ょ」も、1つで 一マス つかいます。',
...
},
{
  ...
  title:'話が かわったら だんらくを かえる',
  childExplanation:'べつの 話に なったら、行を かえて 一マス あけます。',
...
},
{
  ...
  skill:'読点（、）の いれどころ', difficulty:2,
  title:'「、」は ひと休みする ところに 入れる',
  childExplanation:'「、」は 声に 出して 読み、ひと休みする ところに 入れます。',
  correctExample:'夕がた、雨がふったのでかさをさしました。',
  wrongExample:'夕がた雨が、ふったのでかさをさしました。',
  hint:'声に 出して 読んで みよう。どこで ひと休みするかな？',
  questionType:'slot',
  question:'「、」を 入れると 読みやすい ところは どこ？',
...
},
{
  ...
  title:'行の とちゅうで 行を かえない',
  childExplanation:'文が つづく ときは、行の さいごの マスまで つめます。',
...
},
{
  ...
  skill:'「、」「。」の きまり', difficulty:2,
  title:'「、」「。」は 行の いちばん上に 書かない',
  childExplanation:'「、」「。」は 行の いちばん上に 書きません。',
...
},
{
  ...
  childExplanation:'1行目に だい名、2行目に 名前、3行目から 本文です。',
...
},
{
  ...
  childExplanation:'だい名は 上を 2〜3マス あけて 書きます。',
  correctExample:'　　　はるのえんそく',
  wrongExample:'はるのえんそく',
...
},
{
  ...
  childExplanation:'名字と 名前の あいだを 1マス あけて 書きます。',
...
},
{
  ...
  childExplanation:'書きおわったら、さいしょの マスを たしかめよう。',
...
const RULE_VARIANTS = {
  ...
  'RULE-001': [{
    ...
    manuscript:{ cols:10, rows:['　　ぼくのたからもの'] },
    manuscriptLabel:'お手本：上を 2マス あけた だい名',
    answer:false,
    correctExample:'　　ぼくのたからもの', wrongExample:'ぼくのたからもの'
  }],
  'RULE-002': [{
    choices:[
      { manuscript:{ cols:12, rows:['　　　　　田中　みほ'] } },
      { manuscript:{ cols:12, rows:['田中みほ'] } }
    ],
    answer:0,
    correctExample:'下を 1マス あけて　田中　みほ', wrongExample:'いちばん上から　田中みほ'
  }],
  'RULE-012': [{
    choices:[
      { manuscript:{ cols:9, rows:['　きょう、図書かん','へ行きました。'] } },
      { manuscript:{ cols:9, rows:['きょう、図書かんへ','行きました。'] } }
    ],
    answer:0,
    correctExample:'　きょう、図書かんへ行きました。', wrongExample:'きょう、図書かんへ行きました。'
  }],
  'RULE-004': [{
    choices:[
  ...
  'RULE-005': [{
    parts:['きのう','おとうとといっしょに','図書かんへ行きました。'],
    answers:[0,1],
    hint:'「きのう」の あとや、「だれと」の まとまりの あとで ひと休みできるね。',
    correctExample:'きのう、おとうとといっしょに、図書かんへ行きました。', wrongExample:'きのうおとうとと、いっしょに図書かんへ行きました。'
  }],
  'RULE-006': [{
  ...
  /* WORLD 2 文字の どうくつ */
  'RULE-101': [{
    manuscript:{ cols:9, rows:['　ぼくわ、ねこがす','きです。'] },
    answers:[[0,3]],
    hint:'「ぼく◯」の ところだよ。「ぼくは」と 書くね。',
    correctExample:'ぼくは、ねこがすきです。', wrongExample:'ぼくわ、ねこがすきです。'
  }],
  'RULE-102': [{
  ...
  'RULE-302': [{
    choices:[
      { text:'公園へ行って、友だちに会って、おにごっこをして、ジュースをのんで、家へかえりました。' },
      { text:'公園へ行って、友だちに会いました。いっしょに、おにごっこをしました。ジュースをのんで、家へかえりました。' }
    ],
    answer:1,
    correctExample:'公園へ行って、友だちに会いました。いっしょに、おにごっこをしました。', wrongExample:'公園へ行って、友だちに会って、おにごっこをして、ジュースをのんで…'
  }],
  'RULE-303': [{
  ...
  'RULE-402': [{
    question:'「ずっと れんしゅうした きょくが ひけました。」の あとに あう 気もちは？（いくつも 正かい）',
    choices:[
      { text:'ほっと しました。' },
      { text:'うれしく なりました。' },
      { text:'おなかが すきました。' },
    ...
    correctExample:'きょくがひけて、ほっとしました。うれしくなりました。', wrongExample:'きょくがひけました。'
  }],
  'RULE-403': [{
    question:'「どきどき しました。」の つぎに 書くと よいのは？',
    choices:[
      { text:'どきどき しました。' },
      { text:'はじめて 大ぜいの 前で はっぴょうしたからです。' },
      { text:'おわり。' }
    ],
    answer:1,
    hint:'どうして どきどきしたのかが 分かる 文を えらぼう。',
    correctExample:'どきどきしました。はじめて大ぜいの前ではっぴょうしたからです。', wrongExample:'どきどきしました。'
  }],
  'RULE-404': [{
    question:'「海を 見ました。」を くわしく するには？（いくつも 正かい）',
    choices:[
      { text:'なみが ザブーンと 音を 立てていました。' },
      { text:'水が 日の光で きらきら 光っていました。' },
      { text:'海でした。' },
      { text:'すごかったです。' }
    ],
    answers:[0,1],
    hint:'耳で 聞いた なみの音と、目で 見た 光を 書けるね。',
    correctExample:'なみがザブーンと音を立て、水がきらきら光っていました。', wrongExample:'海を見ました。'
  }],
  'RULE-405': [{
  ...
  'RULE-406': [{
    ...
    answer:0,
    correctExample:'とくに、出てくる 人が大声で歌うところでわらいました。', wrongExample:'おもしろかったです。おもしろかったです。おもしろかったです。'
  }],
  'RULE-407': [{
  ...
  'RULE-408': [{
    question:'まおう「ジェットコースターが すごかった！だけで よいのだ！」…もっと つたわるのは どれ？（いくつも 正かい）',
    choices:[
    ...
    correctExample:'風が顔にあたるほどはやく、高いところから一気におりて声が出ました。', wrongExample:'ジェットコースターがすごかったです。'
  }]
};

/* =========================================================
   お手本の げんこう用紙（たて書き 20文字 × 10行）
   だい名・名前・一マス空け・「、」「。」・かい話文が ぜんぶ 入って います
   ========================================================= */
const SAMPLE_GENKOU = {
  cols: 20,
  minRows: 10,
...
const CHECK_ITEMS = [
  ...
  { id:'c7', text:'できごとの あとを くわしく 書いた？',   ruleId:'RULE-401' },
